 ...
 * @version 1.0
 */
$my_sidebar = getMySideBar('wpcf-show_cipherbook','wpcf-show_cipherbook');
get_header();
    ...
    <div class="site-content-contain post_content not_top_border">
        <div class="post_article content-inner inner column center border_bottom">
            <div class="view-header">
                <div class="breadcrumb"><a href="/cipherbook">CipherBook</a></div>
            ...
            if ( $wp_query->have_posts() ) {
                while (have_posts()) {
                    ...
                    <div class="views-row dead-drop-line">
                        <a href="/cipherbook/<?php echo $post->post_name;?>/"><h2><?php echo $post->post_title ?></h2></a>
                    </div>
                    <p><?php the_content(); ?></p>
                    <?php
                }
